...
여러 수를 미리 읽고, 데이터와 검증으로 답을 찾아가는 백엔드 개발자입니다.

바둑을 10년 가까이 두며 한 수의 선택이 이후 흐름을 어떻게 바꾸는지 생각하는 습관을 길렀습니다.
쿠팡에서 SQL과 Excel로 주 3회 Buyble 분석 리포트를 발행하며, 데이터로 판단하는 습관을 익혔습니다.
프로젝트에서는 서비스 흐름을 먼저 파악하고, 동시 처리와 조회 성능, 인증 보안처럼 안정성에 영향을 주는 부분을 코드와 테스트로 개선해 왔습니다.
...
- **경기 AI 멤버십 채용연계형 교육** - 한컴 x 퓨리오사AI / 3개월 / 420시간 (진행중) (2026.08.10 - 2026.11.06)
- **정보처리기사(필기)** (2026.08.28)
